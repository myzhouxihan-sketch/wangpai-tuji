...
(function() {
  var dict = {
    ...
    'en': {
      ...
      '社区': 'Community',
      '更多': 'More',
      '《王牌突击队》': 'Ace Strike Force',
      '《往日之影》': 'Phantom Liberty',
      '《边缘行者》': 'Edgerunners',
      '《边缘行者 2》': 'Edgerunners 2',
      '论坛': 'Forums',
      'COSPLAY 指南': 'Cosplay Guides',
      '配点编辑器': 'Build Planner',
      '游戏手册': 'Game Booklet',
      '夜之城伙计问答': 'Choom Quiz',
      ...
      '职位': 'Jobs',
      '用户协议': 'User Agreement',
      '玩家内容指南': 'Fan Content Guide',
      'Cookie 使用声明': 'Cookie Statement',
      'REDmod': 'REDmod',
      '简体中文': 'English',
      '王牌突击队': 'Ace-Ops'
    },
